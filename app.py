...
app.layout = html.Div([
  html.H3(["SBKE Group Revenues"], style={'textAlign': "center", "padding-bottom": "30"}),
                                                                                                  
  html.H6(["'filter data...' to select Territory, Entity, Code etc. To sort, use arrows"], className="subtitle padded"),
